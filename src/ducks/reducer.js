...
const UPDATE_DOWN_PAY = 'UPDATE_DOWN_PAY';
...
export function updateAgent(agent){
    return { type: UPDATE_AGENT, payload: agent }
}
...
export function updateDownPayment(downPayment){
    return { type: UPDATE_DOWN_PAY, payload: downPayment }
}
...
export function updateAddLineOne(address){
    return { type: UPDATE_ADDRESS_ONE, payload: address }
}

export function updateAddLineTwo(address){
    return { type: UPDATE_ADDRESS_TWO, payload: address }
}

export function updateAddLineThree(address){
    return { type: UPDATE_ADDRESS_THREE, payload: address }
}

export function updateFirst(first){
    return { type: UPDATE_FIRST_NAME, payload: first }
}

export function updateLast(last){
    return { type: UPDATE_LAST_NAME, payload: last }
}
